...
<head>
	...
	<title>Simi IGD | Cari Pasien</title>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								<div class="x_title">
									<h2><b>Cari Pasien</b></h2>
									<div class="clearfix"></div>
								</div>

								<div class="x_content">
									<form class="d-flex">
										<input class="form-control me-12" type="search" placeholder="Masukkan No RM/NIK/Nama/Alamat" name="search" aria-label="Search" value="<?= $search ?>">
									...
									<tbody>
										<?php for ($i = 0; $i < sizeof($pasien); $i++) : ?>
											<tr>
												<th scope="row"><?= $i + 1 ?></th>
												<td><?= $pasien[$i]->nama ?></td>
												<td><?= $pasien[$i]->no_identitas ?></td>
												<td><?= $pasien[$i]->tempat_lahir ?>, <?= $pasien[$i]->tanggal_lahir ?></td>
												<td><?= $pasien[$i]->jenis_kelamin == "M" ? "Laki-laki" : "Perempuan" ?></td>
